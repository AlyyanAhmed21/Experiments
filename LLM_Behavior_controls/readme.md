...
Ensure the model phi3.gguf is downloaded in the working directory.

Run the cells sequentially to launch the Gradio interface and test different behaviour controls.

Adjust temperature, top-k, and top-p sliders to explore different response behaviours.
