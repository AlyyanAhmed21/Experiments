...
All models are **100% FREE** on Groq's API:

| Model | Speed | Quality | Context | Best For |
|-------|-------|---------|---------|----------|
| llama-3.3-70b-versatile | ⚡⚡ | ⭐⭐⭐⭐⭐ | 8k | **General use (default)** |
...
- Update your `.env` file to use `llama-3.3-70b-versatile`
- See `AVAILABLE_MODELS.md` for current models

### Tasks Not Showing
- Make sure you're logged in
- Check the Tasks tab (not just chat)
- Try refreshing the page
- Tasks created in chat should appear in the Tasks tab

### Database Issues
- Delete `data/assistant.db` to reset
- The database will be recreated on next run
- Note: This will delete all users, tasks, and conversations

## 📚 Additional Documentation

- `QUICKSTART.md` - 5-minute quick start guide
- `AVAILABLE_MODELS.md` - List of free Groq models
- `VOICE_FEATURES.md` - Voice input/output setup
- `FIX_API_KEY.md` - API key troubleshooting
...
- **Hugging Face** for local Whisper models
...
For questions or issues, see the troubleshooting section or check the documentation files.
